...
class DMDCalibration:
    ...
    Attributes:
        dmd_shape (tuple[int, int]): shape of the image (default: (1024, 768)).
    ...
    def dmd_to_image(self, coords: np.ndarray) -> np.ndarray:
        ...
        Parameters:
            coords (ndarray): DMD coordinates in pixels. (2,...) array_like.

        Returns:
            coords (ndarray): Image coordinates in the range [0, 1]. (2,...) array_like.
        """
